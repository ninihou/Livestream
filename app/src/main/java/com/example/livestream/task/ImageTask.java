package com.example.livestream.task;
...
public class ImageTask extends AsyncTask<Object, Integer, Bitmap> {
    ...
    public ImageTask(String url, String account, int photo) {
        this(url, account, photo, null);
    }

    public ImageTask(String url, String account, int photo, ImageView imageView) {
        this.url = url;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("action", "findPicByAccount");
